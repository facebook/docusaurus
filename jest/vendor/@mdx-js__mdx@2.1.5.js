  ...
  'node_modules/extend/index.js'(exports, module2) {
    ...
    var isPlainObject2 = function isPlainObject3(obj) {
      ...
      var hasIsPrototypeOf =
        ...
        hasOwn2.call(obj.constructor.prototype, 'isPrototypeOf');
          ...
          for (name2 in options) {
            ...
            if (target !== copy) {
              if (
                ...
                setProperty(target, {
                  name: name2,
                  newValue: extend3(deep, clone, copy),
                });
...
var require_acorn = __commonJS({
  'node_modules/acorn/dist/acorn.js'(exports, module2) {
    (function (global, factory2) {
      ...
      var nonASCIIidentifierStart2 = new RegExp(
        '[' + nonASCIIidentifierStartChars2 + ']',
      );
      var nonASCIIidentifier2 = new RegExp(
      ...
      function isIdentifierStart2(code2, astral) {
        ...
        if (code2 <= 65535) {
          return (
            code2 >= 170 &&
            nonASCIIidentifierStart2.test(String.fromCharCode(code2))
          );
        }
        if (astral === false) {
          return false;
      ...
      function isIdentifierChar2(code2, astral) {
        ...
        if (code2 <= 65535) {
          return (
            code2 >= 170 && nonASCIIidentifier2.test(String.fromCharCode(code2))
          );
        }
        if (astral === false) {
          return false;
        ...
        return (
          isInAstralSet2(code2, astralIdentifierStartCodes2) ||
          isInAstralSet2(code2, astralIdentifierCodes2)
        );
      }
      ...
      function getOptions2(opts) {
        ...
        for (var opt in defaultOptions2) {
          options[opt] =
            opts && hasOwn2(opts, opt) ? opts[opt] : defaultOptions2[opt];
        }
        if (options.ecmaVersion === 'latest') {
          options.ecmaVersion = 1e8;
        } else if (options.ecmaVersion == null) {
          if (
            !warnedAboutEcmaVersion2 &&
      ...
      function functionFlags2(async, generator) {
        return (
          SCOPE_FUNCTION2 |
          (async ? SCOPE_ASYNC2 : 0) |
          (generator ? SCOPE_GENERATOR2 : 0)
        );
      }
      var BIND_NONE2 = 0,
        BIND_VAR2 = 1,
      ...
      var Parser3 = function Parser4(options, input, startPos) {
        ...
        var reservedStrict =
          (reserved ? reserved + ' ' : '') + reservedWords2.strict;
        this.reservedWordsStrict = wordsRegexp2(reservedStrict);
        this.reservedWordsStrictBind = wordsRegexp2(
      ...
      prototypeAccessors2.inGenerator.get = function () {
        return (
          (this.currentVarScope().flags & SCOPE_GENERATOR2) > 0 &&
          !this.currentVarScope().inClassFieldInit
        );
      };
      prototypeAccessors2.inAsync.get = function () {
        return (
          (this.currentVarScope().flags & SCOPE_ASYNC2) > 0 &&
          !this.currentVarScope().inClassFieldInit
        );
      };
      prototypeAccessors2.canAwait.get = function () {
        for (var i2 = this.scopeStack.length - 1; i2 >= 0; i2--) {
          ...
          if (
            ...
            scope.flags & SCOPE_CLASS_STATIC_BLOCK2
          ) {
            return false;
          }
      ...
      prototypeAccessors2.allowNewDotTarget.get = function () {
        ...
        var inClassFieldInit = ref3.inClassFieldInit;
        return (
          (flags & (SCOPE_FUNCTION2 | SCOPE_CLASS_STATIC_BLOCK2)) > 0 ||
          inClassFieldInit
        );
      };
      ...
      Parser3.parseExpressionAt = function parseExpressionAt3(
        input,
        pos,
        options,
      ) {
      ...
      pp$92.strictDirective = function (start3) {
        ...
        for (;;) {
          ...
          if ((match[1] || match[2]) === 'use strict') {
            ...
            var spaceAfter = skipWhiteSpace2.exec(this.input),
              end = spaceAfter.index + spaceAfter[0].length;
            var next = this.input.charAt(end);
            return (
              next === ';' ||
              next === '}' ||
              (lineBreak2.test(spaceAfter[0]) &&
                !(
                  /[(`.[+\-/*%<>=,?^&]/.test(next) ||
      ...
      pp$92.canInsertSemicolon = function () {
        return (
          this.type === types$12.eof ||
          this.type === types$12.braceR ||
          lineBreak2.test(this.input.slice(this.lastTokEnd, this.start))
        );
      };
      ...
      pp$92.checkExpressionErrors = function (
      ...
      pp$82.parseTopLevel = function (node) {
        ...
        if (this.inModule) {
          for (
            var i2 = 0, list4 = Object.keys(this.undefinedExports);
            i2 < list4.length;
            i2 += 1
          ) {
            var name2 = list4[i2];
            this.raiseRecoverable(
              this.undefinedExports[name2].start,
              "Export '" + name2 + "' is not defined",
            );
          }
        }
      ...
      pp$82.isLet = function (context) {
        ...
        if (isIdentifierStart2(nextCh, true)) {
          var pos = next + 1;
          while (
            isIdentifierChar2((nextCh = this.input.charCodeAt(pos)), true)
          ) {
            ++pos;
          }
      ...
      pp$82.isAsyncFunction = function () {
        ...
        var next = this.pos + skip[0].length,
          after;
        return (
          !lineBreak2.test(this.input.slice(this.pos, next)) &&
          this.input.slice(next, next + 8) === 'function' &&
          (next + 8 === this.input.length ||
            !(
              isIdentifierChar2((after = this.input.charCodeAt(next + 8))) ||
      ...
      pp$82.parseStatement = function (context, topLevel, exports3) {
        ...
        switch (starttype) {
          ...
          case types$12._import:
            ...
            return starttype === types$12._import
          ...
          default:
            ...
            if (
              starttype === types$12.name &&
              expr.type === 'Identifier' &&
              this.eat(types$12.colon)
            ) {
      ...
      pp$82.parseForStatement = function (node) {
        ...
        if (
          this.type === types$12._var ||
          this.type === types$12._const ||
          isLet
        ) {
      ...
      pp$82.parseFunctionStatement = function (
        node,
        isAsync,
        declarationPosition,
      ) {
        ...
        return this.parseFunction(
          node,
          FUNC_STATEMENT2 | (declarationPosition ? 0 : FUNC_HANGING_STATEMENT2),
          false,
          isAsync,
        );
      };
      pp$82.parseIfStatement = function (node) {
        ...
        node.alternate = this.eat(types$12._else)
        ...
        if (this.type === types$12._catch) {
          ...
          if (this.eat(types$12.parenL)) {
            ...
            this.checkLValPattern(
              clause.param,
              simple ? BIND_SIMPLE_CATCH2 : BIND_LEXICAL2,
            );
      ...
      pp$82.parseFor = function (node, init) {
        ...
        this.expect(types$12.semi);
        node.update =
          this.type === types$12.parenR ? null : this.parseExpression();
        this.expect(types$12.parenR);
      ...
      pp$82.parseVar = function (node, isFor, kind) {
        ...
        for (;;) {
          ...
          if (this.eat(types$12.eq)) {
            ...
            !(isFor && (this.type === types$12._in || this.isContextual('of')))
          ) {
            this.raise(
              this.lastTokEnd,
      ...
      pp$82.parseVarId = function (decl, kind) {
        ...
        this.checkLValPattern(
          decl.id,
          kind === 'var' ? BIND_VAR2 : BIND_LEXICAL2,
          false,
        );
      };
      ...
      pp$82.parseFunction = function (
        ...
        if (statement & FUNC_STATEMENT2) {
          node.id =
            statement & FUNC_NULLABLE_ID2 && this.type !== types$12.name
              ? null
              : this.parseIdent();
      ...
      pp$82.parseClass = function (node, isStatement) {
        ...
        while (this.type !== types$12.braceR) {
          ...
          if (element2) {
            ...
            if (
              element2.type === 'MethodDefinition' &&
              ...
              element2.key &&
              element2.key.type === 'PrivateIdentifier' &&
              isPrivateNameConflicted2(privateNameMap, element2)
            ) {
              this.raiseRecoverable(
                element2.key.start,
                "Identifier '#" +
      ...
      pp$82.parseClassElement = function (constructorAllowsSuper) {
        ...
        if (!keyName && ecmaVersion2 >= 8 && this.eatContextual('async')) {
          if (
            (this.isClassElementNameStart() || this.type === types$12.star) &&
        ...
        if (
          !keyName &&
          (ecmaVersion2 >= 9 || !isAsync) &&
          this.eat(types$12.star)
        ) {
          isGenerator = true;
        }
        ...
        if (
          ecmaVersion2 < 13 ||
          this.type === types$12.parenL ||
          kind !== 'method' ||
          isGenerator ||
          isAsync
        ) {
          var isConstructor =
            !node.static && checkKeyName2(node, 'constructor');
      ...
      pp$82.isClassElementNameStart = function () {
        return (
          this.type === types$12.name ||
          this.type === types$12.privateId ||
          this.type === types$12.num ||
          this.type === types$12.string ||
          this.type === types$12.bracketL ||
          this.type.keyword
        );
      };
      ...
      pp$82.parseClassMethod = function (
        method,
        isGenerator,
        isAsync,
        allowsDirectSuper,
      ...
      pp$82.parseClassSuper = function (node) {
        node.superClass = this.eat(types$12._extends)
      ...
      function checkKeyName2(node, name2) {
        ...
        return (
          !computed &&
          ((key.type === 'Identifier' && key.name === name2) ||
            (key.type === 'Literal' && key.value === name2))
        );
      }
      pp$82.parseExport = function (node, exports3) {
        ...
        if (this.eat(types$12._default)) {
          ...
          if (
            ...
            node.declaration = this.parseFunction(
              fNode,
              FUNC_STATEMENT2 | FUNC_NULLABLE_ID2,
              false,
              isAsync,
            );
        ...
        if (this.shouldParseExportStatement()) {
          ...
          if (this.eatContextual('from')) {
            ...
            for (
              var i2 = 0, list4 = node.specifiers;
              i2 < list4.length;
              i2 += 1
            ) {
              var spec = list4[i2];
        ...
        if (this.options.ecmaVersion >= 6 && node) {
          switch (node.type) {
            ...
            case 'ObjectExpression':
              ...
              for (
                var i2 = 0, list4 = node.properties;
                i2 < list4.length;
                i2 += 1
              ) {
                var prop = list4[i2];
      ...
      pp$72.parseBindingList = function (
        close,
        allowEmpty,
        allowTrailingComma,
      ) {
      ...
      pp$72.checkLValPattern = function (expr, bindingType, checkClashes) {
        ...
        switch (expr.type) {
          case 'ObjectPattern':
            for (
              var i2 = 0, list4 = expr.properties;
              i2 < list4.length;
              i2 += 1
            ) {
              var prop = list4[i2];
      ...
      var TokContext3 = function TokContext4(
        token,
        isExpr,
        preserveSpace,
        override,
      ...
      pp$62.braceIsBlock = function (prevType) {
        ...
        if (
          prevType === types$12.colon &&
          (parent === types2.b_stat || parent === types2.b_expr)
        ) {
          return !parent.isExpr;
        }
        if (
          prevType === types$12._return ||
          (prevType === types$12.name && this.exprAllowed)
        ) {
          return lineBreak2.test(this.input.slice(this.lastTokEnd, this.start));
        }
        if (
          prevType === types$12._else ||
          prevType === types$12.semi ||
          prevType === types$12.eof ||
          prevType === types$12.parenR ||
          prevType === types$12.arrow
        ) {
          return true;
        }
        ...
        if (
          prevType === types$12._var ||
          prevType === types$12._const ||
          prevType === types$12.name
        ) {
          return false;
        }
      ...
      types$12.parenR.updateContext = types$12.braceR.updateContext =
        function () {
      ...
      types$12.braceL.updateContext = function (prevType) {
        this.context.push(
          this.braceIsBlock(prevType) ? types2.b_stat : types2.b_expr,
        );
        this.exprAllowed = true;
      };
      ...
      types$12.parenL.updateContext = function (prevType) {
        var statementParens =
          prevType === types$12._if ||
          prevType === types$12._for ||
          prevType === types$12._with ||
          prevType === types$12._while;
        this.context.push(statementParens ? types2.p_stat : types2.p_expr);
        this.exprAllowed = true;
      };
      types$12.incDec.updateContext = function () {};
      types$12._function.updateContext = types$12._class.updateContext =
        function (prevType) {
          if (
            prevType.beforeExpr &&
            prevType !== types$12._else &&
            !(
              prevType === types$12.semi && this.curContext() !== types2.p_stat
            ) &&
            !(
              prevType === types$12._return &&
              lineBreak2.test(this.input.slice(this.lastTokEnd, this.start))
            ...
            !(
              (prevType === types$12.colon || prevType === types$12.braceL) &&
              this.curContext() === types2.b_stat
            )
          ) {
      ...
      pp$52.parseMaybeAssign = function (
        forInit,
        refDestructuringErrors,
        afterLeftParse,
      ) {
      ...
      pp$52.parseExprOp = function (
        ...
        if (prec != null && (!forInit || this.type !== types$12._in)) {
          if (prec > minPrec) {
            ...
            if (
              (logical && this.type === types$12.coalesce) ||
              (coalesce &&
                (this.type === types$12.logicalOR ||
                  this.type === types$12.logicalAND))
            ) {
      ...
      pp$52.parseMaybeUnary = function (
        refDestructuringErrors,
        sawUnary,
        incDec,
        forInit,
        ...
        if (this.isContextual('await') && this.canAwait) {
          ...
          var node = this.startNode(),
            update = this.type === types$12.incDec;
          node.operator = this.value;
          node.prefix = true;
          this.next();
          ...
          if (update) {
            ...
            node.operator === 'delete' &&
            isPrivateFieldAccess2(node.argument)
          ) {
            this.raiseRecoverable(
              node.start,
      ...
      function isPrivateFieldAccess2(node) {
        return (
          ...
          (node.type === 'ChainExpression' &&
            isPrivateFieldAccess2(node.expression))
        );
      }
      ...
      pp$52.parseSubscripts = function (
        base2,
        startPos,
        startLoc,
        noCalls,
        ...
        while (true) {
          var element2 = this.parseSubscript(
            base2,
            startPos,
            startLoc,
            noCalls,
          ...
          if (
            element2 === base2 ||
            element2.type === 'ArrowFunctionExpression'
          ) {
            if (optionalChained) {
      ...
      pp$52.parseSubscript = function (
        ...
        if (
          ...
          (optional &&
            this.type !== types$12.parenL &&
            this.type !== types$12.backQuote) ||
          this.eat(types$12.dot)
        ) {
          var node = this.startNodeAt(startPos, startLoc);
          node.object = base2;
          if (computed) {
      ...
      pp$52.parseExprAtom = function (refDestructuringErrors, forInit) {
        ...
        switch (this.type) {
          ...
          case types$12._false:
            node = this.startNode();
            node.value =
              this.type === types$12._null
                ? null
                : this.type === types$12._true;
      ...
      pp$52.parseParenAndDistinguishExpression = function (
        canBeArrow,
        forInit,
      ) {
        var startPos = this.start,
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          while (this.type !== types$12.parenR) {
            ...
            if (
              allowTrailingComma &&
              this.afterTrailingComma(types$12.parenR, true)
            ) {
              lastIsComma = true;
              break;
            } else if (this.type === types$12.ellipsis) {
      ...
      pp$52.parseParenArrowList = function (
        startPos,
        startLoc,
        exprList,
        forInit,
      ...
      pp$52.parseNew = function () {
        ...
        var startPos = this.start,
          startLoc = this.startLoc,
          isImport = this.type === types$12._import;
      ...
      pp$52.isAsyncProp = function (prop) {
        return (
          ...
          (this.type === types$12.name ||
            ...
            this.type === types$12.bracketL ||
            this.type.keyword ||
            (this.options.ecmaVersion >= 9 && this.type === types$12.star)) &&
          !lineBreak2.test(this.input.slice(this.lastTokEnd, this.start))
        );
      };
      pp$52.parseObj = function (isPattern, refDestructuringErrors) {
        ...
        while (!this.eat(types$12.braceR)) {
          if (!first) {
            ...
            if (
              this.options.ecmaVersion >= 5 &&
              this.afterTrailingComma(types$12.braceR)
            ) {
              break;
            }
          } else {
      ...
      pp$52.parseProperty = function (isPattern, refDestructuringErrors) {
        ...
        if (
          ...
          isAsync = true;
          isGenerator =
            this.options.ecmaVersion >= 9 && this.eat(types$12.star);
      ...
      pp$52.parsePropertyValue = function (
        prop,
        isPattern,
        isGenerator,
        isAsync,
      ...
      pp$52.parsePropertyName = function (prop) {
        ...
        return (prop.key =
          this.type === types$12.num || this.type === types$12.string
            ? this.parseExprAtom()
      ...
      pp$52.parseMethod = function (isGenerator, isAsync, allowDirectSuper) {
        ...
        this.awaitIdentPos = 0;
        this.enterScope(
          functionFlags2(isAsync, node.generator) |
            SCOPE_SUPER2 |
            (allowDirectSuper ? SCOPE_DIRECT_SUPER2 : 0),
        );
        this.expect(types$12.parenL);
        node.params = this.parseBindingList(
          types$12.parenR,
      ...
      pp$52.checkUnreserved = function (ref3) {
        ...
        if (
          ...
          (name2 === 'arguments' || name2 === 'await')
        ) {
          this.raise(
            start3,
            'Cannot use ' + name2 + ' in class static initialization block',
          );
        }
        ...
        if (
          this.options.ecmaVersion < 6 &&
          this.input.slice(start3, end).indexOf('\\') !== -1
        ) {
          return;
        }
      ...
      pp$52.parseYield = function (forInit) {
        ...
        this.next();
        if (
          this.type === types$12.semi ||
          this.canInsertSemicolon() ||
          (this.type !== types$12.star && !this.type.startsExpr)
        ) {
          node.delegate = false;
          node.argument = null;
        } else {
      ...
      pp$32.treatFunctionsAsVarInScope = function (scope) {
        return (
          scope.flags & SCOPE_FUNCTION2 ||
          (!this.inModule && scope.flags & SCOPE_TOP2)
        );
      };
      pp$32.declareName = function (name2, bindingType, pos) {
        ...
        if (bindingType === BIND_LEXICAL2) {
          ...
          redeclared =
            scope.lexical.indexOf(name2) > -1 ||
            scope.functions.indexOf(name2) > -1 ||
            scope.var.indexOf(name2) > -1;
          ...
          if (this.treatFunctionsAsVar) {
            ...
            redeclared =
              scope$2.lexical.indexOf(name2) > -1 ||
              scope$2.var.indexOf(name2) > -1;
          }
          ...
          for (var i2 = this.scopeStack.length - 1; i2 >= 0; --i2) {
            ...
            if (
              (scope$3.lexical.indexOf(name2) > -1 &&
                !(
                  scope$3.flags & SCOPE_SIMPLE_CATCH2 &&
                  scope$3.lexical[0] === name2
                )) ||
              (!this.treatFunctionsAsVarInScope(scope$3) &&
                scope$3.functions.indexOf(name2) > -1)
            ) {
              redeclared = true;
              break;
            }
        ...
        if (redeclared) {
          this.raiseRecoverable(
            pos,
            "Identifier '" + name2 + "' has already been declared",
          );
        }
      };
      ...
      var ecma10BinaryProperties2 =
        ecma9BinaryProperties2 + ' Extended_Pictographic';
      var ecma11BinaryProperties2 = ecma10BinaryProperties2;
      var ecma12BinaryProperties2 =
      ...
      var unicodeGeneralCategoryValues2 =
      ...
      function buildUnicodeData2(ecmaVersion2) {
        var d = (data2[ecmaVersion2] = {
          binary: wordsRegexp2(
            unicodeBinaryProperties2[ecmaVersion2] +
              ' ' +
              unicodeGeneralCategoryValues2,
          ),
          nonBinary: {
      ...
      var RegExpValidationState3 = function RegExpValidationState4(parser) {
        ...
        this.unicodeProperties =
          data2[
            parser.options.ecmaVersion >= 13 ? 13 : parser.options.ecmaVersion
          ];
        this.source = '';
        this.flags = '';
        this.start = 0;
      ...
      RegExpValidationState3.prototype.reset = function reset2(
        start3,
        pattern,
        flags,
      ) {
      ...
      pp$12.regexp_pattern = function (state) {
        ...
        for (
          var i2 = 0, list4 = state.backReferenceNames;
          i2 < list4.length;
          i2 += 1
        ) {
          var name2 = list4[i2];
      ...
      pp$12.regexp_validateUnicodePropertyNameAndValue = function (
        state,
        name2,
        value,
      ) {
      ...
      pp$12.regexp_validateUnicodePropertyNameOrValue = function (
        state,
        nameOrValue,
      ) {
      ...
      pp2.readToken = function (code2) {
        if (
          isIdentifierStart2(code2, this.options.ecmaVersion >= 6) ||
          code2 === 92
        ) {
      ...
      pp2.skipBlockComment = function () {
        ...
        if (this.options.locations) {
          for (
            var nextBreak = void 0, pos = start3;
          ...
          switch (ch) {
            ...
            default:
              if (
                (ch > 8 && ch < 14) ||
                (ch >= 5760 &&
                  nonASCIIwhitespace2.test(String.fromCharCode(ch)))
              ) {
                ++this.pos;
              } else {
                break loop;
      ...
      pp2.readToken_pipe_amp = function (code2) {
        ...
        if (next === code2) {
          ...
          return this.finishOp(
            code2 === 124 ? types$12.logicalOR : types$12.logicalAND,
            2,
          );
        }
        if (next === 61) {
        ...
        return this.finishOp(
          code2 === 124 ? types$12.bitwiseOR : types$12.bitwiseAND,
          1,
        );
      };
      ...
      pp2.readToken_plus_min = function (code2) {
        ...
        if (next === code2) {
          if (
            ...
            (this.lastTokEnd === 0 ||
              lineBreak2.test(this.input.slice(this.lastTokEnd, this.pos)))
          ) {
      ...
      pp2.readToken_lt_gt = function (code2) {
        ...
        if (next === code2) {
          size =
            code2 === 62 && this.input.charCodeAt(this.pos + 2) === 62 ? 3 : 2;
      ...
      pp2.readToken_numberSign = function () {
        ...
        this.raise(
          this.pos,
          "Unexpected character '" + codePointToString2(code2) + "'",
        );
      };
      ...
      pp2.readRegexp = function () {
        ...
        var state =
          this.regexpState ||
          (this.regexpState = new RegExpValidationState3(this));
      ...
      pp2.readInt = function (radix, len, maybeLegacyOctalNumericLiteral) {
        ...
        var start3 = this.pos,
          ...
          lastCode = 0;
        for (
          var i2 = 0, e = len == null ? Infinity : len;
          i2 < e;
          ++i2, ++this.pos
        ) {
          var code2 = this.input.charCodeAt(this.pos),
      ...
      pp2.readNumber = function (startsWithDot) {
        ...
        var octal =
          this.pos - start3 >= 2 && this.input.charCodeAt(start3) === 48;
      ...
      pp2.readTmplToken = function () {
        ...
        for (;;) {
          ...
          if (
            ...
            if (
              this.pos === this.start &&
              (this.type === types$12.template ||
                this.type === types$12.invalidTemplate)
            ) {
              if (ch === 36) {
                this.pos += 2;
      ...
      pp2.readWord1 = function () {
        ...
        while (this.pos < this.input.length) {
          ...
          if (isIdentifierChar2(ch, astral)) {
            ...
            if (
              !(first ? isIdentifierStart2 : isIdentifierChar2)(esc, astral)
            ) {
    ...
    function plugin(options, Parser3) {
      ...
      return class extends Parser3 {
        ...
        jsx_readWord() {
          ...
          return this.finishToken(
            tok.jsxName,
            this.input.slice(start3, this.pos),
          );
        }
        jsx_parseIdentifier() {
...
var VFile = class {
  constructor(value) {
    ...
    if (!value) {
      ...
      typeof value === 'string' ||
      (0, import_is_buffer.default)(value)
    ) {
      options = {value};
    } else if (isUrl(value)) {
      options = {path: value};
...
function isIdentifierStart(code2, astral) {
  ...
  if (code2 <= 65535) {
    return (
      code2 >= 170 && nonASCIIidentifierStart.test(String.fromCharCode(code2))
    );
  }
  if (astral === false) {
    return false;
...
function isIdentifierChar(code2, astral) {
  ...
  return (
    isInAstralSet(code2, astralIdentifierStartCodes) ||
    isInAstralSet(code2, astralIdentifierCodes)
  );
}
...
function nextLineBreak(code2, from, end) {
  ...
  for (var i = from; i < end; i++) {
    ...
    if (isNewLine(next)) {
      return i < end - 1 && next === 13 && code2.charCodeAt(i + 1) === 10
        ? i + 2
        : i + 1;
    }
  }
...
pp$9.isContextual = function (name2) {
  return (
    this.type === types$1.name && this.value === name2 && !this.containsEsc
  );
};
...
pp$8.parseTopLevel = function (node) {
  ...
  if (this.inModule) {
    for (
      var i = 0, list3 = Object.keys(this.undefinedExports);
      i < list3.length;
      i += 1
    ) {
      var name2 = list3[i];
  ...
  while (this.type !== types$1.braceR) {
    ...
    if (element2) {
      ...
      if (
        ...
        element2.key &&
        element2.key.type === 'PrivateIdentifier' &&
        isPrivateNameConflicted(privateNameMap, element2)
      ) {
        this.raiseRecoverable(
          element2.key.start,
...
pp$3.declareName = function (name2, bindingType, pos) {
  ...
  if (bindingType === BIND_LEXICAL) {
    ...
    if (this.treatFunctionsAsVar) {
      ...
      redeclared =
        scope$2.lexical.indexOf(name2) > -1 || scope$2.var.indexOf(name2) > -1;
    }
    scope$2.functions.push(name2);
  } else {
    for (var i = this.scopeStack.length - 1; i >= 0; --i) {
      ...
      if (
        (scope$3.lexical.indexOf(name2) > -1 &&
          !(
            scope$3.flags & SCOPE_SIMPLE_CATCH && scope$3.lexical[0] === name2
          )) ||
        (!this.treatFunctionsAsVarInScope(scope$3) &&
          scope$3.functions.indexOf(name2) > -1)
      ) {
...
pp.readToken_pipe_amp = function (code2) {
  ...
  if (next === code2) {
    ...
    return this.finishOp(
      code2 === 124 ? types$1.logicalOR : types$1.logicalAND,
      2,
    );
  }
  if (next === 61) {
  ...
  return this.finishOp(
    code2 === 124 ? types$1.bitwiseOR : types$1.bitwiseAND,
    1,
  );
};
...
pp.readToken_numberSign = function () {
  ...
  this.raise(
    this.pos,
    "Unexpected character '" + codePointToString(code2) + "'",
  );
};
...
function name(name2) {
  ...
  while (++index2 < name2.length) {
    if (!(index2 ? cont2 : start2)(name2.charCodeAt(index2))) return false;
  }
  return index2 > 0;
}
...
function isJsxIdentifierName(name2) {
  let index2 = -1;
  while (++index2 < name2.length) {
    if (!(index2 ? jsxCont : start2)(name2.charCodeAt(index2))) return false;
  }
  return index2 > 0;
}
...
var Scope3 = class {
  ...
  has(name2) {
    return (
      this.declarations.has(name2) || (!!this.parent && this.parent.has(name2))
    );
  }
};
  ...
  return (tree, file) => {
    ...
    for (child of tree.body) {
      if (child.type === 'ExportDefaultDeclaration') {
        ...
        content3 = true;
        replacement.push(
          ...createMdxContent(child.expression, Boolean(layout)),
        );
      } else {
  ...
  map(code2, node) {
    ...
    if (length > 0) {
      if (
        this.lineEndSize > 0 &&
        (lineEnd.length === 1
          ? code2[length - 1] === lineEnd
          : code2.endsWith(lineEnd))
      ) {
...
function zwitch(key, options) {
  ...
  function one3(value) {
    ...
    if (value && own11.call(value, key)) {
      fn = own11.call(handlers2, value[key])
        ? handlers2[value[key]]
        : one3.unknown;
    }
    if (fn) {
...
function parseStyle(value, tagName) {
  ...
  function iterator(name2, value2) {
    if (name2.slice(0, 4) === '-ms-') name2 = 'ms-' + name2.slice(4);
...
function jsxIdentifierName(name2) {
  let index2 = -1;
  while (++index2 < name2.length) {
    if (!(index2 ? cont3 : start2)(name2.charCodeAt(index2))) return false;
  }
  return index2 > 0;
...
function resolveFileAndOptions(vfileCompatible, options) {
  const file = looksLikeAVFile2(vfileCompatible)
    ? vfileCompatible
