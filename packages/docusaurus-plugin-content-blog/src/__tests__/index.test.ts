...
describe('loadBlog', () => {
  ...
  test('simple website', async () => {
    ...
    expect({
      ...
      last_modified: new Date('2019-01-01').valueOf(),
    ...
    expect(
      ...
      last_modified: new Date('2018-12-14').valueOf(),
      tags: [],
      prevItem: {
        permalink: '/blog/date-matter',
        title: 'date-matter',
    ...
    expect({
      ...
      last_modified: new Date('2020-08-16').valueOf(),
    ...
    expect({
      ...
      last_modified: new Date('2020-08-15').valueOf(),
    ...
    expect({
      ...
      last_modified: new Date('2019-01-02').valueOf(),
  ...
  test('create blog post without date', async () => {
    ...
    expect({
      ...
      last_modified: noDateSourceBirthTime.valueOf(),
      formattedDate,
      tags: [],
      prevItem: undefined,
      nextItem: undefined,
