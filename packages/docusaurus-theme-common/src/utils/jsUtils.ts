 ...
 * @returns Value of the elements `v` that has a preceding element `u` where `comparator(u, v) === true`. Values within the returned array are not guaranteed to be unique.
 */
