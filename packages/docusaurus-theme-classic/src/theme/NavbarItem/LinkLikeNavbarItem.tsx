...
const getNavbarItemComponent = (
  type: keyof typeof LinkLikeNavbarItemComponents = 'default',
) => {
  const navbarItemComponent = LinkLikeNavbarItemComponents[type];
...
export default function LinkLikeNavbarItem({
  type,
  ...props
}: Props): JSX.Element {
