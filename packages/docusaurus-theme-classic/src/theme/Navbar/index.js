...
function Navbar({mainWrapperRef}) {
  ...
  const [announcementBarHeight, setAnnouncementBarHeight] = useState(false);
  ...
  const handleScroll = useCallback(() => {
    ...
    if (scrollTop > announcementBarHeight && isAtTop) {
      setIsAtTop(false);
    } else if (scrollTop <= announcementBarHeight) {
      setIsAtTop(true);
    }
  ...
  }, [mainWrapperRef.current, announcementBarHeight]);
  ...
  return (
    <>
      ...
      <nav
        ref={navbarRef}
        style={isAtTop ? {marginTop: announcementBarHeight} : {}}
