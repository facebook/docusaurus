...
declare module '@docusaurus/plugin-content-docs' {
  ...
  export type DocFrontMatter = {
    ...
    /** Allows overriding the last updated date. */
    last_update_time?: FrontMatterLastUpdate['date'];
    /** Allows overriding the author who last updated the doc. */
    last_update_author?: FrontMatterLastUpdate['author'];
    /** Allows overriding the date the doc was created. */
    create_time?: FrontMatterCreation['date'];
    /** Allows overriding the author who created the doc. */
    create_author?: FrontMatterCreation['author'];
  };
