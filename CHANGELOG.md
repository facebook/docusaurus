...
- Enable hiding blog posts in production from the sidebar and the feeds by adding an `unlisted: true` header option ([#1396](https://github.com/facebook/docusaurus/pull/1396), thanks @olafurpg)
- Replace apostrophe with empty string in header slugification ([#1618](https://github.com/facebook/docusaurus/pull/1618), thanks @parthpp)
- Use primary color for highlighted items in table of contents ([#1628](https://github.com/facebook/docusaurus/pull/1628), thanks @parvezakkas)

And we have a number of fixes including bootstrapped footer social links ([#1647](https://github.com/facebook/docusaurus/pull/1647)), PostCSS warning on `build` command ([#1664](https://github.com/facebook/docusaurus/pull/1664), thanks @ybiquitous), and properly render meta description ([#1672](https://github.com/facebook/docusaurus/pull/1672)).

For v2 we've delivered multiple plugins and features that cover image optimization, analytics, theme features such as copy button, SEO, 404 page, and a number of optimizations.

We're also constantly improving our docs in both v1 and v2! Check out [#1649](https://github.com/facebook/docusaurus/pull/1649) (thanks @mesaugat) and [#1615](https://github.com/facebook/docusaurus/pull/1615) (thanks @anurag). We're also welcoming PRs in an umbrella issue for v2 docs, check out [#1640](https://github.com/facebook/docusaurus/pull/1640) if you're interested in contributing.
...
- [moleculerjs-boilerplate](https://pankod.github.io/moleculerjs-boilerplate/) and [next-boilerplate](https://pankod.github.io/next-boilerplate/)
- [Flux](http://facebook.github.io/flux/) (v2)
- [Hermes](https://hermesengine.dev/) (v2)
- [Tech Interview Handbook](https://yangshun.github.io/tech-interview-handbook/) (v2)
