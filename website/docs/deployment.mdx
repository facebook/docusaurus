...
[DeployHQ](https://www.deployhq.com/) is a deployment automation platform that builds your code and pushes it to SSH/SFTP servers, FTP servers, cloud storage (Amazon S3, Cloudflare R2), and modern hosting platforms (Netlify, Heroku).

:::note

DeployHQ does not host your site. It automates building your Docusaurus project and deploying the built files to your chosen hosting provider or server.

:::

To deploy your Docusaurus site using DeployHQ:
...
Your Docusaurus site will be built and deployed to your server. You can enable automatic deployments to deploy on every Git push, or schedule deployments for specific times.
