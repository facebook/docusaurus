...
1. Open your Travis CI dashboard. The URL looks like [https://travis-ci.com/USERNAME/REPO](#triggering-deployment-with-travis-ci), and navigate to the `More options` > `Setting` > `Environment Variables` section of your repository.
...
1.  Go to [https://github.com/USERNAME/REPO/settings/keys](#using-drone) and add a new deploy key by pasting in our public key you just generated.
1.  Open your Drone.io dashboard and login. The URL looks like [https://cloud.drone.io/USERNAME/REPO](#using-drone).
