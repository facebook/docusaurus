...
[mogenius](https://mogenius.com) is a code-to-cloud platform that offers a fully automated cloud infrastructure. With the unlimited free plan you can run any web app, database or API. mogenius provides a service template for Docusaurus so you can deploy it in minutes without any configuration. Follow the tutorial on [how to deploy Docusaurus to mogenius](https://docs.mogenius.com/tutorials/how-to-launch-docusaurus-in-the-cloud).
