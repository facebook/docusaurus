...
### Configuring your Docusaurus project
...
- Include a `build` script in your `package.json`. (Your Docusaurus project should already include this.)
- Install the [`serve`](https://www.npmjs.com/package/serve) package and set the `start` script to `serve build/`.

### Deploying your project

1. Create an account on [Kinsta](https://kinsta.com/signup/?product_type=app-db) or login directly to [My Kinsta](https://my.kinsta.com/) admin panel.
...
You can also check out our [Docusaurus Starter](https://github.com/kinsta/hello-world-docusaurus).
