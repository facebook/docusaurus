...
Access [Azion Console](https://console.azion.com/) here. Get started by following [this step-by-step guide](https://www.azion.com/en/documentation/products/guides/docusaurus-javascript-boilerplate/).
