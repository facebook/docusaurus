...
### Netlify CMS
If you want to use Netlify CMS to manage your pages, blog posts and documentation, Please Create folder structure like below,
...
<head>
  ...
  <!-- Include the script for Netlify Identity Widget -->
...
After netlify deployment, [Create your netlify identity](https://docs.netlify.com/visitor-access/identity/), Now you can login to `your_netlify_url.netlify.com/admin` or `localhost:3000/admin` to do GUI based editing in pages, blogs and docs .
