...
## Deploying to Pergola {#deploying-to-pergola}

[Pergola](https://docs.pergola.cloud/docs/overview) is a deployment and runtime platform for web and server applications, built by developers for developers. The platform gives you a high-availability cluster with auto-scaling, failover handling, fully managed TLS certificates and much more, but without all the complexity.

Follow our [Docusaurus on Pergola guide](https://github.com/datasophie/docusaurus-pergola/blob/main/README.md) and get started in a matter of minutes.
