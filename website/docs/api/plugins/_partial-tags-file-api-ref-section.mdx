...
Use the `[tags plugion option](#tags)` to configure the path of a YAML tags file. By convention, the plugin will read a `tags.yml` file at the root of your content folder(s).
