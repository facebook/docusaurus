...
| `tags` | `string \| false \| null \| undefined` | `tags.yml` | A path to the file that defines tags. |
| `onInlineTags` | `'ignore' \| 'log' \| 'warn' \| 'throw'` | `warn` | The behavior of Docusaurus when it found inline tags. |
