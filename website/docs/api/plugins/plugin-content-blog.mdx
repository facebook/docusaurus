...
| `tags` | `Tag[]` | `undefined` | A list of strings or objects of two string fields `label` and `permalink` to tag to your post. Strings can be a reference to keys in `tags.yml` |
...
import TagsFile from './_tags-partials-example.mdx';
