...
| `docVersionLayoutComponent` | `string` | `'@theme/DocPage'` | Parent layout component of all versioned docs pages (doc pages with sidebars, tags pages). Stays mounted when navigation between such pages. |
