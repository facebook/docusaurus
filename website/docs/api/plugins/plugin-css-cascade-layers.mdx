...
This plugin is mostly designed to be used from the classic preset through the [Docusaurus `v4.useCssCascadeLayers` future flag](../docusaurus.config.js.mdx#future), although it can also be used as a standalone plugin.
