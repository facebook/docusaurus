...
| `lastmod` | `boolean | "date"` | `true` | Enables or disables generating lastmod; if set to date, lastmod will be truncated to date and not include the timestamp. See [sitemap docs](https://www.sitemaps.org/protocol.html#xmlTagDefinitions) |
