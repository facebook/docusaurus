...
Optionally, you can add tags to your blog pages. Tags are passed in the front matter as a list of labels:

### Inline tags {#inline-tags}

Tags are considered inline when they are not defined in a global configuration file. You can configure how to report inline tags with [`onInlineTags`](./api/plugins/plugin-content-blog.mdx#onInlineTags).
