...
You can activate it independently for each author by adding `page: true` to the [global author configuration](#global-authors).
...
The blog plugin will now generate for each of these authors:

- a dedicated author page, listing all the blog posts they contributed to ([example](/blog/authors/slorber)
- an index page listing all the authors ([example](/blog/authors))

:::warning About inline authors

Only [global authors](#global-authors) can opt in for this feature. [Inline authors](#inline-authors) are not supported.
