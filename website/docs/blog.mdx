...
The `readingTime` callback receives three parameters: the blog content text as a string, front matter as a record of string keys and their values, and the default reading time function, provided by [reading-time](https://github.com/ngryman/reading-time). It returns a number (reading time in minutes) or `undefined` (disable reading time for this page)
      ...
      '@docusaurus/preset-classic',
      {
        blog: {
          ...
          readingTime: ({content, defaultReadingTime}) =>
            defaultReadingTime(content, {wordsPerMinute: 100}),
          // highlight-end
        },
      },
    ],
