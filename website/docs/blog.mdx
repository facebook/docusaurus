...
There's also a "Docs-only mode" for those who only want to use the docs at the basePath = "/". Follow the setup instructions on [Docs-only mode](../guides/docs/docs-introduction.md).
