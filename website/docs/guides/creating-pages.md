...
Markdown pages allows you to use [markdown features](markdown-features.mdx) in your pages, which may be more convenient than creating React pages. However, markdown pages are less flexible than React pages, because it always uses the theme layout.
