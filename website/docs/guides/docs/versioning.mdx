...
- Create a versionedfrom your current [s sidebars file based idebar](./sidebar#sidebar) configuration (if it exists) - saved as `versioned_sidebars/version-[versionName]-sidebars.json`.
