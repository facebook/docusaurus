...
With [autogenerated](#sidebar-item-autogenerated) sidebars, a document named `index.md` automatically linked to its parent category.

:::

##### Generated-Index link {#category-document-link}
...
- `docs/Guides/README.mdx`
- `docs/Guides/Guides.md`
- `docs/<categoryName>/<categoryName>.md`

This is equivalent to using a category with a [doc links](#category-doc-link):
...
Name your introductory documents `index.md` or `readme.md`.
