...
/website/docs/assets/docusaurus-asset-example.zip
```
...
<a
  target="_blank"
  href={require('./assets/docusaurus-asset-example.zip').default}>
  Download this zip
</a>

or

[Download this zip using Markdown](./assets/docusaurus-asset-example.zip)
```
