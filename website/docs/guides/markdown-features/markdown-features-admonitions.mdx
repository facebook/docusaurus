...
- `appendKeywords`: Should the provided option `keywords` be merged into the existing default keywords. Defaults to `true`.
...
You can register a custom React component for `:::my-custom-admonition` by creating the following file:
...
Now you can use your new admonition keyword in Markdown file, and it will be with your custom rendering logic:
