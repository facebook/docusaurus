...
To take advantage of the [Font Awesome](https://mermaid-js.github.io/mermaid/#/flowchart?id=basic-support-for-fontawesome) support in Mermaid you need to add the FontAwesome 5 CSS to Docusaurus by adding a stylesheet to your config.
