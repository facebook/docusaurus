...
| Visual UI | 🎨 Easy | Use tools for complex tables |

:::tip visual table generator

Manually aligning pipes (`|`) and dashes (`-`) for large tables can be tedious and error-prone. To speed up your workflow, you can use a **[Markdown Table Generator](https://99tools.net/markdown-table-generator)** to visually design your tables and paste the code directly into your docs.
