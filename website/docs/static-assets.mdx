...
We'll take a look at how we can reference various file types using relative path for both markdown and JSX files. Let's imagine we have the following file structure:
...
```
# Your markdown file, where you want to use some assets 
...
```
# Your JS file, where you want to use some assets 
...
This results in displaying the following links:
