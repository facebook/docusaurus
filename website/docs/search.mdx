...
export default {
  ...
  themeConfig: {
    ...
    algolia: {
      ...
      // Optional: incase you want to use the new ask ai feature
...
Ask AI is a new feature that allows you to ask questions about your documentation. It is only available with the latest version of DocSearch (v4).
...
To enable it, you need to add the `askAi` field to your `algolia` field in the `docusaurus.config.js` file.
...
To use Ask AI, you need to have an Algolia index with the Ask AI assistant enabled. Learn more about how to [setup Ask AI](https://docsearch.algolia.com/docs/v4/ask-ai/create-an-assistant/).
