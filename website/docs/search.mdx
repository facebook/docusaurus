...
:::tip
Search results won't work when you run Algolia locally. You'll need to build the site, not just run it. Indexing won't be available until you push to live!
:::
