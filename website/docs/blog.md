...
- `draft` - A boolean flag to indicate that the blog post work is in process and therefore should not be published yet. However, draft blog posts will be displayed during development.
