...
List the [theme](./using-plugins.md), [plugins](./using-plugins.md), and [presets](./using-plugins.md) for your site in the `themes`, `plugins`, and `presets` fields, respectively. These are typically npm packages:
