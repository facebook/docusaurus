---
description: GM is a tool for management. You can use it to manage games, user admin, config games, and events help reduce operating time. was designed from the ground up to be easily installed and used to get your website up and running quickly.
slug: /
---
