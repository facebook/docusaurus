...
You can link to static assets (e.g. images, stylesheets, favicons) directly from your markdown files. More information can be found in the documentation for [Static Assets](static-assets.mdx).
