...
The `rightToc` variable is available in any MDX document, and contain all the top level headings of a MDX document.
...
You can create this TOC tree manually, or derive a new TOC tree from the `rightToc` variable:
...
<TOCInline toc={[rightToc[3], rightToc[4]]} />
