...
Docusaurus also offers support for the themed images. It is useful if you need to switch the whole image based on the current theme.
...
<ThemedImage
  alt="Docusaurus themed image"
  lightSrc={useBaseUrl('img/docusaurus_light.svg')}
  darkSrc={useBaseUrl('img/docusaurus_dark.svg')}
/>;
```
...
<ThemedImage
  ...
  darkSrc={useBaseUrl('img/docusaurus_speed.svg')}
/>
