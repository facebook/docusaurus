...
This tutorial uses the CLI version `v5`, but newer versions should keep working.

Install the Crowdin CLI as an npm package to your Docusaurus site:

```bash npm2yarn
npm install @crowdin/cli@5
```
...
### Machine Translation (MT) issue: links/image handling {/* #machine-translation-mt-issue-linksimage-handling */}
