...
You can now [deploy](../deployment/index.mdx) the `build` folder to the static hosting solution of your choice.
...
On your [static hosting provider](../deployment/index.mdx):
