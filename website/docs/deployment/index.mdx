...
In the following guides, we will introduce the most popular hosting providers and how they should be configured to deploy Docusaurus sites most efficiently. Docusaurus is not affiliated with any of these services, and this information is provided for convenience only.
...
We can only document officially a very limited subset of hosting providers.

However, most hosting providers support static website deployments and are compatible with Docusaurus.

Our **[GitHub Discussion category - Deployment Platforms](https://github.com/facebook/docusaurus/discussions/categories/deployment-platforms)** is a good place for the community to find alternative deployment platforms, and for hosting providers to explain how to use Docusaurus on their platform.
