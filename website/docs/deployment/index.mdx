...
- Jamstack providers (e.g. [Netlify](./netlify.mdx) and [Vercel](./vercel.mdx)). We will use them as references, but the same reasoning can apply to other providers.
- [GitHub Pages](./github-pages.mdx) (by definition, it is also Jamstack, but we compare it separately).
