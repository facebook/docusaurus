...
## Upgrading your Docusaurus site {/* #upgrading-your-docusaurus-site */}
...
## DocSearch has a new home! {/* #docsearch-has-a-new-home */}

### What is DocSearch? {/* #what-is-docsearch */}
...
## What is this migration about? {/* #what-is-this-migration-about */}
...
### Where can I read more about this? {/* #where-can-i-read-more-about-this */}
...
### I received the migration email but the invite expired {/* #i-received-the-migration-email-but-the-invite-expired */}
...
### Can I still run my own DocSearch instance? {/* #can-i-still-run-my-own-docsearch-instance */}
