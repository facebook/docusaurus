...
This release improves Docusaurus faster with a new `gitEagerVcs` flag (explained below in [VCS](#vcs) section below) and [full support for Yarn PnP](https://github.com/facebook/docusaurus/pull/11817).
...
Historically, Docusaurus compiled your files with MDX v1, which was quite forgiving. Since then, the whole ecosystem has widely moved to MDX v3, which is stricter. Docusaurus v3 introduced `markdown.mdx1Compat` to help you upgrade incrementally.
...
- This improves compatibility with the Unified/Remark/Rehype ecosystem and the [MDX Playground](https://mdxjs.com/playground/).
