...
### Google Tag Manager plugin {/* #google-tag-manager-plugin */}
...
Therefore, we are also **deprecating our existing [`@docusaurus/plugin-google-analytics`](https://github.com/facebook/docusaurus/issues/7221)** package. Docusaurus users should create a new Google Analytics 4 property, and migrate to the [gtag.js plugin](/docs/api/plugins/@docusaurus/plugin-google-gtag/), or the [Google Tag Manager plugin](/docs/api/plugins/@docusaurus/plugin-google-tag-manager/). Refer to the [dedicated Docusaurus issue](https://github.com/facebook/docusaurus/issues/7221) for details and questions.

:::

### Tabs Query String Support {/* #tabs-query-string-support */}
...
### Blog `createFeedItems` {/* #blog-createfeeditems */}
