...
If bundling time is a concern, consider disabling `optimization.concatenateModule`. We explain the tradeoffs and how to do it [here](https://github.com/facebook/docusaurus/discussions/11199). For a very large site, this change was incredibly impactful: 4x faster on cold builds, x16 faster rebuilds 🔥.
