...
We have upgraded the [React Native website to Docusaurus v3.8](https://github.com/facebook/react-native-website/pull/4607) already. Here's an updated benchmark showing the global Docusaurus Faster impact on a site with 2000 pages:
...
| ------------------------------ | ------------------ | ------------------ |
| ❌ Docusaurus Slower (webpack) | 146s (baseline)    | 45s (3.2 × faster) |
| ✅ Docusaurus Faster (Rspack)  | 42s (3.5 × faster) | 24s (6.1 × faster) |
