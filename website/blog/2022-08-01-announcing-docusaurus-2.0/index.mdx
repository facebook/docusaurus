...
The work on Docusaurus v2 [started in 2018](/blog/2018/09/11/Towards-Docusaurus-2). Since then, the community has been quick to adopt it. It didn't take long for **Docusaurus v2 to outgrow Docusaurus v1** in terms of NPM downloads, despite being in beta:

[![NPM downloads: v2 outgrows v1](./img/npm-downloads.png)](https://npmtrends.com/docusaurus-vs-@docusaurus/core)

Our GitHub star trend is very positive, and we compete with major frameworks:
