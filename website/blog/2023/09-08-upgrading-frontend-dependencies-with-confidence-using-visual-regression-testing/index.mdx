...
But a config is not enough, and we also need to write a Playwright test file to tell Playwright to generate the site screenshots.
...
TODO: Docusaurus specific, requires patch release + backport
