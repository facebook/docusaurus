...
MDX v2, all the related official packages (Unified, Remark, Rehype...) are now [**ES Modules only**](https://gist.github.com/sindresorhus/a39789f98801d908bbc7ff3ecc99d99c) and do not support anymore [CommonJS](https://nodejs.org/api/modules.html#modules-commonjs-modules).
...
You can start refactoring your config to use async dynamic imports today.
...
Apart MDX, there are other breaking changes that you can already prepare your site for, notably major version upgrades of important dependencies.

### Node.js 18.0

Node.js 16 [reached End-of-Life](https://nodejs.org/en/blog/announcements/nodejs16-eol), and Docusaurus v3 now requires a minimum version of **Node.js 18.0**.
...
Although using the former base config might not break your site, we recommend to use our new official package.

```diff
 {
   "devDependencies": {
-    "@tsconfig/docusaurus": "^1.0.0",
+    "@docusaurus/tsconfig": "^3.0.0",
   }
 }
```

https://github.com/facebook/docusaurus/pull/9258

https://github.com/facebook/docusaurus/pull/9050
...
When creating version `v1.0.0`, the sidebar file contained a prefix `version-v1.0.0/` that [Docusaurus v3 won't support anymore](https://github.com/facebook/docusaurus/pull/9310).
...
Docusaurus v3 is now [in beta](https://github.com/facebook/docusaurus/discussions/9312), and used in production by [React-Native](https://reactnative.dev), [Jest](https://jestjs.io) and [our own website](https://docusaurus.io/).

We would appreciate if you tried upgrading to the beta and [report issues](https://github.com/facebook/docusaurus/discussions/9312) that

Support v3: https://github.com/facebook/docusaurus/discussions/9336

Beta: https://github.com/facebook/docusaurus/discussions/9312

```

"dependencies": { "@docusaurus/core": "2.4.3", "@docusaurus/preset-classic": "2.4.3", "@mdx-js/react": "^1.6.22", "@docusaurus/core": "3.0.0-beta.0", "@docusaurus/preset-classic": "3.0.0-beta.0", "@mdx-js/react": "^2.3.0", "clsx": "^1.2.1", "prism-react-renderer": "^1.3.5", "react": "^17.0.2", "react-dom": "^17.0.2" "react": "^18.2.0", "react-dom": "^18.2.0" }, "devDependencies": { "@docusaurus/module-type-aliases": "2.4.3" "@docusaurus/module-type-aliases": "3.0.0-beta.0" },
...
To support you during this transition to MDX v2 and Docusaurus v3, we created a few useful channels:
...
Alternatively, you can look for a paid [Docusaurus Service Provider](https://github.com/facebook/docusaurus/discussions/9281) to do these upgrades for you. If your site is open source, you can also ask our community for [free, benevolent help](https://github.com/facebook/docusaurus/discussions/9283).
