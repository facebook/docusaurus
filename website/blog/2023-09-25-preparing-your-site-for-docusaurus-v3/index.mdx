...
In practice this means that you can't do `require("remark-plugin")` anymore. Unfortunately the Docusaurus config file only supports CommonJS, and `import MyRemarkPlugin from "remark-plugin"` won't work.
...
Apart MDX, there are other breaking changes that you can already prepare your site for.
