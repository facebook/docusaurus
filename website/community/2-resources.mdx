...
- [docusaurus-plugin-statuspage](https://github.com/mcclowes/docusaurus-plugin-statuspage) - Shows a discreet banner when your [Statuspage](https://www.atlassian.com/software/statuspage) reports degraded service or an ongoing incident, linking readers to the status page.
