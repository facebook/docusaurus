...
- [docusaurus-plugin-umami](https://github.com/PatelN123/docusaurus-plugin-umami) - A plugin that links your site to Umami analytics, an open source analytics platform.
