...
Uma lista selecionada de projetos interessantes da comunidade Docusaurus.
...
- [F8 2019: usando o Docusaurus para criar sites de código aberto](https://www.youtube.com/watch?v=QcGJsf6mgZE)
...
- [Edição de código ao vivo no Docusaurus](https://dev.to/mrmuhammadali/live-code-editing-in-docusaurus-ux-at-its-best-2hj1)
...
Veja a <a href={require('@docusaurus/useBaseUrl').default('showcase')}>vitrine</a>.

## Plugins da comunidade {#community-plugins}
...
- [docusaurus-plugin-moesif](https://github.com/Moesif/docusaurus-plugin-moesif) - Adiciona [Moesif API Analytics](https://www.moesif.com/) para rastrear o comportamento do usuário e identificar onde desenvolvedores desistem no funil de ativação.
...
- [docusaurus-plugin-sass](https://github.com/rlamana/docusaurus-plugin-sass) - Suporte a folhas de estilos Sass/SCSS
...
- [docusaurus-protobuffet](https://github.com/protobuffet/docusaurus-protobuffet) - Ferramentas Docusaurus para documentação de contrato Protobuf
...
## Uso empresarial {#enterprise-usage}
