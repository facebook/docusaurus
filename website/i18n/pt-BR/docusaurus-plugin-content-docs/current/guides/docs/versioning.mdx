...
### Marcando uma nova versão {#tagging-a-new-version}
...
### Criando novos documentos {#creating-new-docs}
...
### Atualizando uma versão existente {#updating-an-existing-version}
...
### Excluindo uma versão existente {#deleting-an-existing-version}
...
2. Exclua o diretório de documentos versionados. Exemplo: `versioned_docs/version-1.8.0`.
3. Exclua o arquivo de barras laterais com versão. Exemplo: `versioned_sidebars/version-1.8.0-sidebars.json`.

## Configuring versioning behavior {#configuring-versioning-behavior}

A versão "atual" é o nome da versão da pasta `./docs`. Existem diferentes maneiras de gerenciar versionamento, mas dois padrões muito comuns são:
...
### Versão de sua documentação apenas quando necessário {#version-your-documentation-only-when-needed}
...
### Mantenha o número de versões pequeno {#keep-the-number-of-versions-small}
...
### Usar importação absoluta nos docs {#use-absolute-import-within-the-docs}
