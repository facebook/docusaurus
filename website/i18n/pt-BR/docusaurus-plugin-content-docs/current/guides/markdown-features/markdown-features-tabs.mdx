---
id: tabs
description: Usando abas dentro do Docusaurus Markdown
...
## Exibindo uma aba padrão {#displaying-a-default-tab}
...
## Sincronizando opções de guia {#syncing-tab-choices}
...
## Personalizando abas {#customizing-tabs}
