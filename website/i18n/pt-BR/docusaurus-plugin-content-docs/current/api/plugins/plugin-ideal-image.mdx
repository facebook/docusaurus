...
| `sizes`        | `number[]` | _original size_                               | Specify all widths you want to use. Se um tamanho específico exceder a largura da imagem original, este último será usado (ou seja, as imagens não serão dimensionadas).                                                               |
