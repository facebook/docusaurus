---
description: Como tornar seu site Docusaurus o mais amigável em seus mecanismos de busca.
sidebar_label: SEO
keywords:
  - seo
  - posicionamento
...
Docusaurus apoia a otimização de mecanismos de busca em diversas formas.

## Metadados globais {#global-metadata}
