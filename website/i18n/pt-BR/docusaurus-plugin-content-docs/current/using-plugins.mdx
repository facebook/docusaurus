...
## Instalando um plugin {#installing-a-plugin}
...
## Configurando plugins {#configuring-plugins}
...
## Usando predefinições {#using-presets}
...
Isso é especialmente útil quando alguns plugins e temas se destinam a ser usados juntos. You can even link their options together, e.g. pass one option to multiple plugins.
