...
## Referenciando seu arquivo estático {#referencing-your-static-asset}
...
- Por padrão, o GitHub Pages executa arquivos publicados através do [Jekyll](https://jekyllrb.com/). Uma vez que o Jekyll irá descartar quaisquer arquivos que comecem com `_`, é recomendável que você desative o Jekyll adicionando um arquivo vazio chamado `.nojekyll` para o seu diretório `static` se você estiver usando páginas do GitHub para hospedagem.
