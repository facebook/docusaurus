...
Também há um "modo somente blog" para aqueles que só querem usar o recurso do blog do Docusaurus 2. Você pode usar o mesmo método detalhado acima. Follow the setup instructions on [Blog-only mode](../../blog.mdx#blog-only-mode).
