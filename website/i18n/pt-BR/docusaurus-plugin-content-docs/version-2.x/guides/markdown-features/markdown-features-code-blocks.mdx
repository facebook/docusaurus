...
Blocos de código são blocos de texto envolvidos por strings de 3 crases (backticks). You may check out [this reference](https://github.com/mdx-js/specification) for the specifications of MDX.
