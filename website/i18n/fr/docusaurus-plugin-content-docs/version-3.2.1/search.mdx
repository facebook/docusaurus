...
Le service est **gratuit** pour toute documentation de développeur ou blog technique : il suffit de lire la [liste de contrôle](https://docsearch.algolia.com/docs/who-can-appy/) et l'[appliquer au programme DocSearch](https://docsearch.algolia.com/apply).
