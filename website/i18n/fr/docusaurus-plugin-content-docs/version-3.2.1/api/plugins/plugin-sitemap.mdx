...
| `changefreq`     | `string \| null`               | `'weekly'`    | Voir [docs sitemap](https://www.sitemaps.org/protocol.html#xmlTagDefinitions)                                                                              |
| `priority`       | `number \| null`               | `0.5`         | Voir [docs sitemap](https://www.sitemaps.org/protocol.html#xmlTagDefinitions)                                                                              |
