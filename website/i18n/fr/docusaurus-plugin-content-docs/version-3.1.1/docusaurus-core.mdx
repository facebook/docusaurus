...
Un hook React pour accéder aux API du vérificateur de liens défectueux de Docusaurus, exposant un moyen pour une page Docusaurus de rapporter et de collecter ses liens et ses ancrages. :::warning Ceci est une API **avancée** que **la plupart des utilisateurs de Docusaurus n'ont pas besoin d'utiliser directement**.
