...
[VuePress](https://vuepress.vuejs.org/) présente de nombreuses similitudes avec Docusaurus - tous deux ciblent principalement les sites web centrés sur le contenu et proposent des fonctionnalités de documentation "out of the box". Cependant, VuePress est propulsé par Vue, tandis que Docusaurus est propulsé par React. Si vous voulez une solution basée sur Vue, VuePress serait un choix décent.
