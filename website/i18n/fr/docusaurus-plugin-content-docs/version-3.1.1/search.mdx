...
Il est fortement recommandé d'utiliser une configuration similaire à la [**configuration du site web Docusaurus v3**](https://docsearch.algolia.com/docs/templates/#docusaurus-v2-template).
