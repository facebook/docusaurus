...
Si vous n'utilisez pas **[Joi](https://www.npmjs. om/package/joi)** pour la validation vous pouvez lancer une erreur en cas d'options non valides et retourner des options en cas de succès.
