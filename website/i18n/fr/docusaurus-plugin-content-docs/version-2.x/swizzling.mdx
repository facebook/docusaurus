...
Cette section est similaire au [Style et mise en page](./styling-layout.mdx), mais cette fois, nous allons écrire du code React concret au lieu de jouer avec des feuilles de style. Nous allons aborder un concept clé de Docusaurus : **le swizzling**, qui permet des **personnalisations de site plus poussées**.
