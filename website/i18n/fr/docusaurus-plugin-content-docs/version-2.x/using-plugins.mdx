  ...
  presets: [
    [
      '@docusaurus/preset-classic',
      {
        ...
        sitemap: {},
        // Sera passé à @docusaurus/plugin-google-gtag (n'est activée que si explicitement spécifiée)
        gtag: {},
        // Sera passé à @docusaurus/plugin-google-tag-manager (n'est activée que si explicitement spécifiée)
        googleTagManager: {},
        // DÉPRECIÉ : Sera passé à @docusaurus/plugin-google-analytics (n'est activée que si explicitement spécifiée)
        googleAnalytics: {},
      },
    ],
  ],
