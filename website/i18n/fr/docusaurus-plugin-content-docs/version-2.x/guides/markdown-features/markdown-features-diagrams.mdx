...
Consultez la [documentation de configuration de Mermaid ](https://mermaid-js.github.io/mermaid/#/./Setup?id=configuration) pour les options de configuration disponibles.
