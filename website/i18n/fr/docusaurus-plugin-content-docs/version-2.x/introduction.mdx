...
Les utilisateurs de la v1 qui cherchent à passer à la v2 peuvent suivre notre [guide de migration](./migration/migration-overview.mdx).
...
- ⚡️ **Rapide comme l'éclair**. Docusaurus 2 suit le [Modèle PRPL](https://developers.google.com/web/fundamentals/performance/prpl-pattern/) qui garantit un chargement rapide de votre contenu.
