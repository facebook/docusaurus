...
Il est **facile de traduire un site web Docusaurus** grâce à son support de l'internationalisation ([i18n](https://en.wikipedia.org/wiki/Internationalization_and_localization)).

## Objectifs {#goals}

Il est important de comprendre les **décisions de conception** derrière le support de Docusaurus i18n.

Pour plus de contexte, vous pouvez lire les textes initiaux [RFC](https://github.com/facebook/docusaurus/issues/3317) et [PR](https://github.com/facebook/docusaurus/pull/3325).
...
- **Facile à utiliser avec [Crowdin](https://crowdin.com/)**: plusieurs sites Docusaurus v1 utilisent Crowdin, et devraient être en mesure de migrer vers la v2
- **Bon SEO par défaut** : nous définissons des en-têtes SEO utiles comme [`hreflang`](https://developers.google.com/search/docs/advanced/crawling/localized-versions) pour vous
...
- [Thèmes i18n](../api/themes/theme-configuration.mdx#i18n)
