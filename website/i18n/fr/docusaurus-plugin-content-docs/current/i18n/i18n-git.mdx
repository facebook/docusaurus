...
Une **stratégie de traduction possible** est de **piloter les fichiers de traduction** avec Git (ou tout autre [VCS](https://en.wikipedia.org/wiki/Version_control)).
...
Consultez la [RFC Docusaurus i18n](https://github.com/facebook/docusaurus/issues/3317) pour nos notes et liens étudiant ces systèmes.
