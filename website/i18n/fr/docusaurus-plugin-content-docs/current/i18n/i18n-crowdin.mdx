...
Reportez-vous à la documentation **[de Crowdin](https://support.crowdin.com/)** et **[au support de Crowdin](mailto:support@crowdin.com)** pour obtenir de l'aide.

:::

:::tip

Utilisez cette **[discussion GitHub gérée par la communauté](https://github.com/facebook/docusaurus/discussions/4052)** pour discuter de tout ce qui concerne Docusaurus + Crowdin.

:::

## Vue d'ensemble de Crowdin {#crowdin-overview}

Crowdin est une traduction SaaS, offrant un [plan gratuit pour les projets open-source](https://crowdin.com/page/open-source-project-setup-request).
...
![Créer un projet Crowdin avec l'anglais comme langue source, et le français comme langue cible](/img/crowdin/crowdin-create-project.png)
...
### Créez la configuration de Crowdin {#create-the-crowdin-configuration}
...
- évitez les pratiques de globalisation sophistiquées comme `/docs/**/*.(md|mdx)` (ne fonctionne pas)
...
Vous pouvez obtenir un `jeton d'accès personnel` sur [votre page de profil personnel](https://crowdin.com/settings#api-key).
...
![Crowdin CLI déversant des fichiers source Docusaurus](/img/crowdin/crowdin-upload-sources-cli.png)
...
![Crowdin UI montrant les fichiers source de Docusaurus](/img/crowdin/crowdin-source-files.png)
...
![Crowdin UI montrant les fichiers de traduction français](/img/crowdin/crowdin-french-translations.png)

Traduisez des fichiers Markdown.

![Crowdin UI pour traduire un fichier Markdown](/img/crowdin/crowdin-translate-markdown.png)
...
![Chaîne de masquage de l'interface utilisateur Crowdin](/img/crowdin/crowdin-hide-string.png)

:::

Traduisez des fichiers JSON.

![Crowdin UI pour traduire un fichier JSON](/img/crowdin/crowdin-translate-json.png)
...
**[Pré-traduisez](https://support.crowdin.com/pre-translation-via-machine/)** votre site et **corrigez manuellement les erreurs de pré-traduction** (activez d'abord la Mémoire de Traduction Globale dans les paramètres).
...
### Automatisez avec CI {#automate-with-ci}
...
![Paramètre d'option Crowdin Duplicate Strings](/img/crowdin/crowdin-settings-duplicate-strings.png)
...
![Crowdin CLI : avertissement de traduction de téléchargement](/img/crowdin/crowdin-download-translations-warning.png)
...
![Crowdin UI : renommer un fichier](/img/crowdin/crowdin-files-rename.png)
...
Crowdin a une fonctionnalité [traduction dans le contexte](https://support.crowdin.com/in-context-localization/).
...
### Problème de traduction automatique (MT) : gestion des liens et des images

Crowdin a récemment apporté des modifications majeures au format de fichier markdown et les liens sont désormais traités différemment. Auparavant, ils étaient considérés comme des balises, mais maintenant ils apparaissent comme du texte brut. En raison de ces changements, les liens en texte brut sont transmis au moteur MT qui tente de traduire la cible, ce qui perturbe la traduction (par exemple : la chaîne `Allez voir [ma merveilleuse page](/ma-merveilleuse-page)` est traduite `Check out [my wonderful page](/my-wonderful-page)`, ce qui perturbe le flux de travail i18n de docusaurus car le nom de la page ne devrait pas être traduit).

A partir du 7 décembre 2023, ils ne prévoient pas de changer la logique de traitement des liens, vous devez donc garder cela à l'esprit si vous prévoyez d'utiliser Crowdin avec MT.
