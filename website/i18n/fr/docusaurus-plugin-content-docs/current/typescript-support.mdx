...
Docusaurus prend en charge l'écriture et l'utilisation de composants de thèmes TypeScript. If the init template provides a TypeScript variant, you can directly [initialize a site](./installation.mdx#scaffold-project-website) with full TypeScript support by using the `--typescript` flag.
...
## Saisir le fichier de configuration {#typing-config}
...
## Swizzler les composants de thème TypeScript {#swizzling-typescript-theme-components}
