...
| `blogSidebarTitle`            | `string`                                                                                                                     | `'Articles récents'`                       | Titre de la barre latérale du blog.                                                                                                                                                                                                                                                                                        |
...
| `feedOptions.limit`           | `number \| null \| false`                                                                                                  | `20`                                       | Limite le flux au nombre spécifié de messages, `false` ou `null` pour avoir toutes les entrées. Par défaut, `20`.                                                                                                                                                                                                          |
...
| `feedOptions.language`        | `string` (Voir la [documentation](http://www.w3.org/TR/REC-html40/struct/dirlang.html#langcodes) pour les valeurs possibles) | `undefined`                                | Métadonnées de langue du flux.                                                                                                                                                                                                                                                                                             |
...
const config = {
  path: 'blog',
  // Cas simple : une chaine editUrl
  // editUrl: 'https://github.com/facebook/docusaurus/edit/main/website/',
  // Cas avancé : une fonction editUrl
...
| `tags`                   | `Tag[]`                 | `undefined`                                    | Une liste de chaînes ou d'objets de deux champs de chaînes `label` et `permalink` pour tagger à votre article. Strings can be a reference to keys of a [tags file](#tags-file) (usually `tags.yml`)                                                                            |
...
| `keywords`               | `string[]`              | `undefined`                                    | Balise meta des mots clés, qui deviendra le `<meta name="keywords" content="keyword1,keyword2,..."/>` dans `<head>`, utilisé par les moteurs de recherche.                                                                                                         |
