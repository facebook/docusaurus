...
Beaucoup de plugins officiels Remark/Rehype sont [**uniquement des ES Modules**](https://gist.github.com/sindresorhus/a39789f98801d908bbc7ff3ecc99d99c), un système de modules JavaScript, que Docusaurus prend en charge. Nous recommandons d'utiliser un fichier de config [**ES Modules**](https://flaviocopes.com/es-modules/) pour faciliter l'importation de tels paquets.
