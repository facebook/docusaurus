...
### Documentation des SDKs mobiles {#mobile-sdks-documentation}

Si vous construisez un SDK mobile multi-plateforme, vous pouvez avoir 2 documentations :

- Documentation de Android SDK (`v1.0`, `v1.1`)
...
`@docusaurus/preset-classic` inclut déjà une instance de plugin docs pour vous !
...
## Taguer les nouvelles versions {#tagging-new-versions}
...
Chaque élément du thème [lié à la documentation](../../api/themes/theme-configuration.mdx#navbar) prend un attribut facultatif `docsPluginId`.
