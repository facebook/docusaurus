  ...
  presets: [
    [
      '@docusaurus/preset-classic',
      {
        ...
        // highlight-next-line
        blog: false, // Facultatif : désactive le plugin de blog
        // ...
      },
    ],
  ],
...
Il y a aussi un « mode blog-uniquement » pour ceux qui ne veulent utiliser que la fonction blog de Docusaurus. Vous pouvez utiliser la même méthode décrite ci-dessus. Suivez les instructions de configuration sur le [mode Blog-only](../../blog.mdx#blog-only-mode).
