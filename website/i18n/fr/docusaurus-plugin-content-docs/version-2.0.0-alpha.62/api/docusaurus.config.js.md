...
An object containing data needed by the theme you use.<!--, see \[theme configurations\](#).-->For Docusaurus' default theme _classic_, we use `themeConfig` to customize your navbar and footer links:
