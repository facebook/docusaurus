...
Il y a aussi un « mode blog-uniquement » pour ceux qui ne veulent utiliser que la fonction blog de Docusaurus. Vous pouvez utiliser la même méthode décrite ci-dessus. Suivez les instructions d'installation sur le [mode Blog-Uniquement](../../blog.mdx#blog-only-mode).
