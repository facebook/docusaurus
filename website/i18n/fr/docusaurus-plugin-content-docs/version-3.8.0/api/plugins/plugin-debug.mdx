...
Le plugin de débogage affichera des informations de débogage utiles à l'adresse [`http://localhost:3000/__docusaurus/debug`](http://localhost:3000/__docusaurus/debug).
...
<TabItem value="preset" label="Options du preset">
```
...
<TabItem value="plugin" label="Options du plugin">
```
