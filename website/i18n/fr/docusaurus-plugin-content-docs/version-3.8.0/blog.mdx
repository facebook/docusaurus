...
- `defaultReadingTime`: the default built-in reading time function. Il renvoie un nombre (temps de lecture en minutes) ou `undefined` (pour désactiver le temps de lecture pour cette page).
