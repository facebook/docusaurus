---
id: tabs
description: 도큐사우루스 마크다운 안에서 탭을 활용합니다.
...
도큐사우루스는 [MDX](./markdown-features-react.mdx) 기반으로 `<Tabs>` 컴포넌트를 마크다운에서 사용할 수 있게 지원합니다.
...
## 탭 선택 항목 동기화 {#syncing-tab-choices}
...
## 탭에 사용자 지정 스타일 적용하기 {#customizing-tabs}
...
### 탭 제목 사용자 지정하기 {#customizing-tab-headings}
