...
도큐사우루스는 **[Markdown](https://commonmark.org/)**을 주요 콘텐츠 작성 형식으로 사용합니다.

:::tip Learn Markdown

[10분 만에](https://commonmark.org/help/) Markdown을 배울 수 있어요.

:::

도큐사우루스는 여러분이 문서를 쉽게 작성할 수 있도록 최신의 도구를 사용하고 있습니다.
