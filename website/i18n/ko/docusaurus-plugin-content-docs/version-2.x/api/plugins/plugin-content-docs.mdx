...
| `versions`                           | <code>[VersionsConfig](#PrefixParser)</code>               | `{}`                                     | 각 버전의 속성을 독립적으로 사용자 지정합니다.                                                                                                                                                                                                                     |
...
| `custom_edit_url`        | `string`                    | Computed using the `editUrl` plugin option | 문서를 편집하기 위한 URL                                                                                                                                                                                                    |
