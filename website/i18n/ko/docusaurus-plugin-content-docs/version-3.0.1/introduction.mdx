...
[VuePress](https://vuepress.vuejs.org/) has many similarities with Docusaurus - both focus heavily on content-centric website and provides tailored documentation features out of the box. VuePress는 Vue를 기반으로, Docusaurus는 React를 기반으로 만들어졌다는 차이가 있습니다. Vue 기반의 솔루션을 원한다면 VuePress가 적절한 선택일 것입니다.
