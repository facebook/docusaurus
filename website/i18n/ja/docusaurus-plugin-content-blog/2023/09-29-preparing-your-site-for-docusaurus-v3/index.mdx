---
title: サイトをDocusaurus v3に移行するための準備
authors:
  - slorber
tags:
  - maintenance
...
本ブログ記事には多くの内容が書かれていますが、多くのDocusaurus v2サイトはほとんど変更を加えずにアップグレードできます。

あなたのサイトが比較的小規模で、いくつかのカスタマイズしかしていない場合は、おそらくすぐに[Docusaurus v3にアップグレード](#try-docusaurus-v3-today)することができます。
