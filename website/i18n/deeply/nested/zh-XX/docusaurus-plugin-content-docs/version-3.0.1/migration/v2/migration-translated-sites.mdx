...
本页解释了如何将翻译的 Docusaurus v1 网站迁移到 Docusaurus v2。

## i18n differences {#i18n-differences}

Docusaurus v2 i18n 在概念上类似于Docusaurus v1 i18n，但有一些差异。

它不会与Crowdin紧密相连，你可以使用Git或另一个SaaS。
...
Docusaurus v2是基于插件系统的模块，每个插件都负责管理自己的翻译。
