...
| `changefreq`         | `string \| null`                | `'weekly'`    | 见[站点地图文档](https://www.sitemaps.org/protocol.html#xmlTagDefinitions)                                                                                        |
| `priority`           | `number \| null`                | `0.5`         | 见[站点地图文档](https://www.sitemaps.org/protocol.html#xmlTagDefinitions)                                                                                        |
