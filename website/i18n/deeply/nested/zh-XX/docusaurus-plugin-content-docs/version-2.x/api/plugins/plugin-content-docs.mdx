...
| `sidebarPath`                        | <code>false \| string</code>                               | `undefined`                              | 侧边栏配置的路径。 Use `false` to disable sidebars, or `undefined` to create a fully autogenerated sidebar.                                                                                                                                             |
...
| `versions`                           | <code>[VersionsConfig](#PrefixParser)</code>               | `{}`                                     | 独立自定义每个版本的属性。                                                                                                                                                                                                                                  |
