...
- Create a versioned sidebars file based from your current [sidebar](sidebar#sidebar) configuration (if it exists) - saved as `versioned_sidebars/version-[versionName]-sidebars.json`.
