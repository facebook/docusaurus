...
- Read through the [Docusaurus docs](https://docusaurus.io/docs/installation). If you find anything that is confusing or can be improved, you can make edits by clicking "Edit" at the top of most docs (saving the edit will make a fork).
...
1. Add the [copyright notice](#copyright-header-for-source-code) to the top of any new files you've added.
