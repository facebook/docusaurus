...
const loadConfig = require('../../packages/docusaurus-1.x/lib/server/config.js');

const siteConfig = loadConfig(`${CWD}/siteConfig.js`);
const translation = require('../../packages/docusaurus-1.x/lib/server/translation.js');
const env = require('../../packages/docusaurus-1.x/lib/server/env.js');

const translate = require('../../packages/docusaurus-1.x/lib/server/translate.js')
  .translate;
const setLanguage = require('../../packages/docusaurus-1.x/lib/server/translate.js')
  .setLanguage;

const readMetadata = require('../../packages/docusaurus-1.x/lib/server/readMetadata.js');

readMetadata.generateMetadataDocs();
const Metadata = require('../../packages/docusaurus-1.x/lib/core/metadata.js');
const {
  idx,
  getPath,
} = require('../../packages/docusaurus-1.x/lib/core/utils.js');
