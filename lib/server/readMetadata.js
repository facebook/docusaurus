...
function generateMetadataDocs() {
  ...
  Object.keys(metadatas).forEach(function(metadata) {
    if (metadatas[metadata].hasOwnProperty('previous') && metadatas.hasOwnProperty(metadatas[metadata].previous)) {
      metadatas[metadata].previous_title = metadatas[metadatas[metadata].previous].title;
    }
    if (metadatas[metadata].hasOwnProperty('next') && metadatas.hasOwnProperty(metadatas[metadata].next)) {
