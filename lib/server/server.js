...
function execute(port) {
  ...
  if (process.env.NODE_ENV === 'development') {
    const server = tinylr();
    server.listen(LIVE_RELOAD_PORT, function() {
      console.log('Livereload listening on %s...', LIVE_RELOAD_PORT);
    });

    // Gaze watches some specified files and triggers a callback when they change.
    gaze(['../docs/**/*', 'blog/**/*', 'pages/**/*', 'static/**/*'], function() {
      ...
      this.on('all', function() {
        ...
        // the root has changes, so they will do a full-page refresh.
