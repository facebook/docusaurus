...
function execute() {
  ...
  if (env.translation.enabled) {
    languages = env.translation.languages;
  } else {
    languages = [];
  }
  ...
  Object.keys(Metadata).forEach(id => {
    ...
    const str = renderToStaticMarkup(reactApp);
  ...
  /**
   * This is partially duplicate code (along with the blog)
   * But is much less sever, and requires to be able to test more.
   */
