...
// Reason is not currently supported by the HighlightJS npm package
HighlightJS.registerLanguage('reason', function(hljs) {
  var SWIFT_KEYWORDS = {
...
class Markdown extends React.Component {
  render() {
    ...
    return <div>{remarkable.render("# Remarkable rulezz!st")}</div>;
  }
}
