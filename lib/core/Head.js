...
class Head extends React.Component {
  render() {
    ...
    const siteUrl = urljoin(this.props.config.url, this.props.config.baseUrl);
    ...
    return (
      <head>
        ...
        {this.props.config.ogImage && (
          <meta
            property="og:image"
            content={urljoin(siteUrl, this.props.config.ogImage)}
          />
        )}
        ...
        {this.props.config.twitterImage && (
          <meta
            name="twitter:image"
            content={urljoin(siteUrl, this.props.config.twitterImage)}
          />
        )}
        ...
        <link
          rel="shortcut icon"
          href={urljoin(this.props.config.baseUrl, this.props.config.favicon)}
        />
        ...
        {hasBlog && (
          <link
            ...
            href={urljoin(siteUrl, 'blog/atom.xml')}
        ...
        {hasBlog && (
          <link
            ...
            href={urljoin(siteUrl, 'blog/feed.xml')}
        ...
        {this.props.config.usePrism && (
          <link
            rel="stylesheet"
            href={urljoin(this.props.config.baseUrl, 'css/prism.css')}
          />
        )}
        {/* Site defined code. Keep these at the end to avoid overriding. */}
        <link
          rel="stylesheet"
          href={urljoin(this.props.config.baseUrl, 'css/main.css')}
        />
      </head>
    );
  }
