...
> **We are working hard on Docusaurus v2. If you are new to Docusaurus, try using the new version instead of v1. See [v2.docusaurus.io](https://v2.docusaurus.io/) for more details.**
