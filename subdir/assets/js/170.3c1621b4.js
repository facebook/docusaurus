...
/* harmony export */ });
/* harmony import */ var _styles_622362e4_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(16525);
...
/* harmony import */ var _index_f58d48f9_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(30198);
...
const sanitizeText = (txt) => _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.e.sanitizeText(txt, (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.c)());
let conf = {
  dividerMargin: 10,
  padding: 5,
  textHeight: 10,
...
const addNamespaces = function(namespaces, g, _id, diagObj) {
  ...
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info(namespaces);
  keys.forEach(function(id) {
    ...
    const node = {
      ...
      padding: ((_a = (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.padding) ?? ((_b = (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.c)().class) == null ? void 0 : _b.padding)
    };
    g.setNode(vertex.id, node);
    addClasses(vertex.classes, g, _id, diagObj, vertex.id);
    _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info("setNode", node);
  });
};
const addClasses = function(classes, g, _id, diagObj, parent) {
  const keys = Object.keys(classes);
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info(classes);
...
const addNotes = function(notes, g, startEdgeId, classes) {
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info(notes);
  notes.forEach(function(note, i) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.o)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    g.setEdge(vertex.id, vertex.class, edgeData, edgeId);
  });
};
const addRelations = function(relations, g) {
  const conf2 = (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart;
  let cnt = 0;
  relations.forEach(function(edge) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.o)(conf2 == null ? void 0 : conf2.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info(edgeData, edge);
    if (edge.style !== void 0) {
      const styles2 = (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.k)(edge.style);
    ...
    if (edge.text === void 0) {
      ...
      edgeData.arrowheadStyle = "fill: #333";
      edgeData.labelpos = "c";
      if (((_a = (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.htmlLabels) ?? (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.c)().htmlLabels) {
        edgeData.labelType = "html";
        edgeData.label = '<span class="edgeLabel">' + edge.text + "</span>";
      } else {
        edgeData.labelType = "text";
        edgeData.label = edge.text.replace(_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing class - ", id);
  const conf2 = (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart ?? (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.c)().class;
  const securityLevel = (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info("config:", conf2);
  ...
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.l.info(relations);
  ...
  await (0,_index_f58d48f9_js__WEBPACK_IMPORTED_MODULE_8__.r)(
    element,
    g,
  ...
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.u.insertTitle(svg, "classTitleText", (conf2 == null ? void 0 : conf2.titleTopMargin) ?? 5, diagObj.db.getDiagramTitle());
  (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_7__.p)(g, svg, conf2 == null ? void 0 : conf2.diagramPadding, conf2 == null ? void 0 : conf2.useMaxWidth);
...
;// CONCATENATED MODULE: ../node_modules/mermaid/dist/createText-3b1f58a4.js
...
const createText = (el, text = "", {
  ...
  mermaid_768dc893.l.info("createText", text, style, isTitle, classes, useHtmlLabels, isNode, addSvgBackground);
  if (useHtmlLabels) {
    const htmlText = markdownToHTML(text);
    const node = {
      isNode,
      label: (0,mermaid_768dc893.L)(htmlText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63294);
/* harmony import */ var _createText_3b1f58a4_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(51568);
/* harmony import */ var _svgDraw_70101091_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(97312);
...
/* harmony import */ var _edges_0005682e_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(40577);
...
/* harmony import */ var _createText_3b1f58a4_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(51568);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(63294);
...
let functions = [];
const sanitizeText = (txt) => _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(txt, (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_1__.c)());
...
const addRelation = function(relation) {
  _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_1__.l.debug("Adding relation: " + JSON.stringify(relation));
  addClass(relation.id1);
  addClass(relation.id2);
  relation.id1 = splitClassNameAndType(relation.id1).className;
  relation.id2 = splitClassNameAndType(relation.id2).className;
  relation.relationTitle1 = _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(
    relation.relationTitle1.trim(),
    (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_1__.c)()
  );
  relation.relationTitle2 = _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(
...
const setLink = function(ids, linkStr, target) {
  const config = (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_1__.c)();
  ids.split(",").forEach(function(_id) {
    let id = _id;
    if (_id[0].match(/\d/)) {
      id = MERMAID_DOM_ID_PREFIX + id;
    ...
    if (classes[id] !== void 0) {
      classes[id].link = _mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_1__.u.formatUrl(linkStr, config);
...
const db = {
  ...
  getConfig: () => (0,_mermaid_768dc893_js__WEBPACK_IMPORTED_MODULE_1__.c)().class,
  addClass,
  bindFunctions,
  clear,
  getClass,
